	...
	{
		size(width,height);
		r=new PVector(6370e3,0);//set up vector
		v=new PVector(0,0);
		a=new PVector(0,0);
		G=new PVector();
		ar=new PVector(11,0);
	...
	void reset()//when click reset button
	{
		c=2;
		k=1;
		t=0;
	...
	void calm()//calculation of mass
	{
		if(k==1&&m[3]>=0)
		{
			m[3]=m[3]-(666.5)*dt;// is Effective exhaust velocity of liquid oxygen and hydrogen, 11 is constant acelreration of rocket
		}
	...
	void printmass()
	{
		...
		fill(0,255,0);
		rect(xt,yt+100+30,40,-m[3]*100/m3);
